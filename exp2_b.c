...
void key_process() {
	...
	//K3
	if(key_states[K3].output_level == 1 && key_states[K3].output_trig_up == 1  && (key_states[K3].trig_up_ms - key_states[K3].trig_down_ms) > PRESS_TIME_MS_SHORT && (key_states[K3].trig_up_ms - key_states[K3].trig_down_ms)< PRESS_TIME_MS_LONG)	
	{
		HAL_CPU_Sleep();	
	}
	//K4
	if(key_states[K4].output_level == 1 && key_states[K4].output_trig_up == 1  && (key_states[K4].trig_up_ms - key_states[K4].trig_down_ms)> PRESS_TIME_MS_LONG)
		HAL_CPU_Reset();
	//K5
	if(key_states[K5].output_level == 1 && key_states[K5].output_trig_up == 1  && (key_states[K5].trig_up_ms - key_states[K5].trig_down_ms) > PRESS_TIME_MS_SHORT && (key_states[K5].trig_up_ms - key_states[K5].trig_down_ms)< PRESS_TIME_MS_LONG){
		if(!k5_push)
			k5_push = 1;
		else{
			led_flash = 1;
	...
	//K6
	if(key_states[K6].output_level == 0 && key_states[K6].output_trig_down == 0){
